...
plot_model(m2_anger_dems, type = "pred", terms = c("t1judicial", "adverse_ruling", "republican_therm_1 [0, 20, 80]"))
...
plot_model(m3_anger_dems, type = "pred", terms = c("t1judicial", "adverse_ruling", "dem_norm_index [-5, -2, 1]"))
...
plot_model(m2_anger_reps, type = "pred", terms = c("t1judicial", "adverse_ruling", "democrat_therm_1 [0, 20, 80]"))
...
plot_model(m3_anger_reps, type = "pred", terms = c("t1judicial", "adverse_ruling", "dem_norm_index [-4, -1, 2]"))
...
plot_model(m2_court_conf_dems, type = "pred", terms = c("t1judicial", "adverse_ruling", "republican_therm_1 [0, 20, 80]"))
...
plot_model(m2_court_conf_reps, type = "pred", terms = c("t1judicial", "adverse_ruling", "democrat_therm_1 [0, 20, 80]"))
...
plot_model(m2_elex_conf_dems, type = "pred", terms = c("t1judicial", "adverse_ruling", "republican_therm_1 [0, 20, 80]"))
...
plot_model(m3_elex_conf_dems, type = "pred", terms = c("t1judicial", "adverse_ruling", "dem_norm_index [-5, -2, 1]"))
...
plot_model(m2_elex_conf_reps, type = "pred", terms = c("t1judicial", "adverse_ruling", "democrat_therm_1 [0, 20, 80]"))
...
m2.anger <- lm(anger ~ t2outcome*pid3*t1judicial , data = survey_data)
summary(m2.anger)

plot_model(m2.anger, type = "pred", terms = c("t2outcome", "t1judicial", "pid3 [Democrat, Independent, Republican]"))
```
